...
the Knitting-Aid is every knitters companion! This adorable teacup-shaped product helps a knitter (or crocheter) keep track of their rows and informs them when it is time to make a change! This specific model shows the knitter when they are on every 10th row to increase or decrease their stitches. You simply need to press the teabag shaped button after you have completed a row, and it will keep track of the total rows. When you reach the 10th row, a little tune will play and a cyan light will turn on!

To see what row number you are on, you simply open a flap to allow the light sensor to recieve light. The row count will be separated into the numbers based on how many place values there are. The RGB light on the lilypad tells you whether pink LEDs will show you the ones, tens, or hundreds place! The red is the ones, green is the tens, and blue is the hundreds. The 4 pink LEDs will light up a number from 1-9 shown in binary code and 0 is represented by all of them on. When you reach every 10th row by pressing your completed 9th row, the RGB light with turn cyan and the Tinkerbell DS Game Title Theme music plays. The tune only plays once, but the cyan light will be on until you complete the 10th row.
